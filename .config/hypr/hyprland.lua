...
-- Source: ~/.config/hypr/subconfigurations/colors.conf — convert this file to Lua and ensure it is on Lua's package.path.
...
hl.bind("Print", hl.dsp.exec_cmd("grimblast --freeze copysave area ".. home .. "/Pictures/Screenshots"))
